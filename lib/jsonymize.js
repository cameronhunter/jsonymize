...
export default class Jsonymize {
  ...
  aliases(aliases) {
    return this.copy({ aliases: aliases });
  }

  extensions(...extensions) {
    return this.copy({ extensions: [].concat(...extensions) });
  }

  fields(...fields) {
    return this.copy({ fields: [].concat(...fields) });
  }

  generators(generators) {
    return this.copy({ generators: generators });
  }
