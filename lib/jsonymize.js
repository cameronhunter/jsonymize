...
export default class Jsonymize {
  ...
  aliases(aliases) {
    return new Jsonymize(Object.assign({}, this[_options], { aliases: Object.assign({}, this[_options].aliases, aliases) }));
  }

  extensions(...extensions) {
    return new Jsonymize(Object.assign({}, this[_options], { extensions: this[_options].extensions.concat(...extensions) }));
  }

  fields(...fields) {
    return new Jsonymize(Object.assign({}, this[_options], { fields: this[_options].fields.concat(...fields) }));
  }

  generators(generators) {
    return new Jsonymize(Object.assign({}, this[_options], { generators: Object.assign({}, this[_options].generators, generators) }));
  }
